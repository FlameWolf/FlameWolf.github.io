...
const cipherSchemes = {
	moolabhadri: {
		...
		conjunctsToReplace: ["ക", "കാ", "കി", "കീ", "കു", "കൂ", "കൃ", "കൄ", "കൢ", "കൣ", "കെ", "കേ", "കൈ", "കൊ", "കോ", "കൗ", "കൌ", "കം", "കഃ", "ക്ഷ", "ങ്ക", "ഞ്ച", "ണ്ട", "ന്ത", "മ്പ", "ഩ്ഩ", "ൻ്റ", "ന്‍റ", "റ്റ", "ന്‍", "ല്‍", "ര്‍", "ള്‍"]
	},
	moolabhadri_v2: {
		...
		conjunctsToReplace: ["ക", "കാ", "കി", "കീ", "കു", "കൂ", "കൃ", "കൄ", "കൢ", "കൣ", "കെ", "കേ", "കൈ", "കൊ", "കോ", "കൗ", "കൌ", "കം", "കഃ", "ക്ഷ", "റ്റ", "ൻ്റ"]
	}
};
