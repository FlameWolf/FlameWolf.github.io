...
/** One less than Malayalam Unicode block start (3328-3455) */
const MALAYALAM_BLOCK_OFFSET = 3327;
/** Offset used to compress ASCII values into available space */
 ...
 * @param {string} text Malayalam text to encode
 * @returns {string} Encoded string
 */
function encodeMalayalam(text) {
 ...
 * @returns {string} Original Malayalam text
 */
